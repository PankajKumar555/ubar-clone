      ...
      <div className="relative">
        <div className="mb-3 mt-2">
          <p className="flex items-center text-gray-700 text-sm font-semibold">
            ...
            Lane Number 3, Pote Chawl, Mate Nagar, Wadgaon Sheri, 411014
          </p>
        </div>
        ...
        <div className="mb-3">
          ...
          <p className="flex items-center text-gray-700 text-sm font-semibold">
            <TbLocationFilled className="mr-2 text-4xl" />
            Dropoff: behind Sun Residency, Phase 1, Jambhulkar road, Hinjawadi,
